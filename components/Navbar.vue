<template>
  <b-navbar sticky toggleable="lg" variant="light" :class="{ 'navbar--hidden': !showNavbar }">
    <b-navbar-brand to="/">
      <img v-if="window.width > 990" width="135px" src="/assets/img/static_assets_img_logo.png" />
      <img v-else width="30px" src="/assets/img/logo3.png" />
    </b-navbar-brand>

    <div class="input mx-auto" v-if="this.$route.path == '/' && window.width > 990">
    ...
    <b-collapse class="" id="nav-collapse" is-nav>
      <b-navbar-nav class="ml-auto">
        <b-navbar-nav class="ml-auto text-right" v-if="$store.state.loggedIn">
...
<style lang="scss">
  .navbar {
    ...
    background-color: #fed04d !important;
  }
